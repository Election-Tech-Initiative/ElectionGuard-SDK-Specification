...
```
The modulus p is then set to be the largest 4096-bit prime which is one greater than a multiple of q.  This works out to <img src="/tex/e863240c42c2b7280d0fe4d5daf5b06e.svg?invert_in_darkmode&sanitize=true" align=middle width=439.09913190000003pt height=26.76175259999998pt/>.
