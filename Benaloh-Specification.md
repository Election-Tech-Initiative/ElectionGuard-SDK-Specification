...
<img src="/tex/67d7691542c38a6746ffb7e1be8171d7.svg?invert_in_darkmode&sanitize=true" align=middle width=101.24338124999998pt height=22.831056599999986pt/>  
...
In order to prove possession of the coefficient associated with each public commitment, for each <img src="/tex/8016e096be8cea0d188804885a9a1de4.svg?invert_in_darkmode&sanitize=true" align=middle width=62.72388869999999pt height=22.831056599999986pt/>{ 0 \leq j \leq k }<img src="/tex/a11cc1ddfc1fc9b8a09b8e540908d127.svg?invert_in_darkmode&sanitize=true" align=middle width=59.47506179999999pt height=20.221802699999984pt/>{T_i}<img src="/tex/8c232f89c1ec780d3df32500d1733b8e.svg?invert_in_darkmode&sanitize=true" align=middle width=787.7744985pt height=47.67123240000001pt/>{T_i}<img src="/tex/dfe3940b9b140346f7dcf6563c756cff.svg?invert_in_darkmode&sanitize=true" align=middle width=183.1618998pt height=22.831056599999986pt/>{ a_{i,j} }<img src="/tex/2d6b4bef0bc89eb7b236d145f01e15ac.svg?invert_in_darkmode&sanitize=true" align=middle width=63.73313429999999pt height=22.831056599999986pt/>{ K_{i,j}=g^{a_{i,j}} \mod p }<img src="/tex/e73cd2d50f10d7a34ad92ab25698cb60.svg?invert_in_darkmode&sanitize=true" align=middle width=58.12239179999999pt height=22.465723500000017pt/>{T_i}<img src="/tex/6ab3f8ca332dd01e2e9d7ecc12c625a3.svg?invert_in_darkmode&sanitize=true" align=middle width=229.17245340000002pt height=22.831056599999986pt/>{ R_{i,j} }<img src="/tex/be8ad2f82badb68d57b58d5983675994.svg?invert_in_darkmode&sanitize=true" align=middle width=81.10493324999999pt height=22.831056599999986pt/>{ 0 \leq r_{i,j} < q }<img src="/tex/4d8bc018b884e08fce7fddf6ff4e566f.svg?invert_in_darkmode&sanitize=true" align=middle width=95.60350469999999pt height=22.831056599999986pt/>{ h_{i,j}=g^{R_{i,j}} \mod p }<img src="/tex/39dd2f3cb25b3ad2b7a798cada23b5a7.svg?invert_in_darkmode&sanitize=true" align=middle width=58.58662919999999pt height=22.831056599999986pt/>{ 0 \leq j < k }<img src="/tex/740d5a8c77a4366b317433292bf57973.svg?invert_in_darkmode&sanitize=true" align=middle width=602.12766735pt height=24.65753399999998pt/>{T_i}<img src="/tex/45b99486d56f8ae93fd8266ea2d5e6b8.svg?invert_in_darkmode&sanitize=true" align=middle width=284.3526213pt height=22.831056599999986pt/>{ c_i=H({Q,K_{i,0},K_{i,1},K_{i,2},…,K_{i,k-1},h_{i,0},h_{i,1},h_{i,2},…h_{i,k-1}}) \mod q }<img src="/tex/176b4b8e41e80a348401924f3b3b17b5.svg?invert_in_darkmode&sanitize=true" align=middle width=165.58199295pt height=22.831056599999986pt/>{ K_{i,j}, <img src="/tex/18cc01aa3bc0da39aa279be83c752521.svg?invert_in_darkmode&sanitize=true" align=middle width=29.518730999999992pt height=22.831056599999986pt/>{c_i }<img src="/tex/4316f0f92a6c3f658e16968da37a0c95.svg?invert_in_darkmode&sanitize=true" align=middle width=34.41787799999999pt height=22.831056599999986pt/>{u_{i,j)=(R_{i,j}+c_i a_{i,j} ) \mod q }<img src="/tex/2116262693b61050f12857beee6a470e.svg?invert_in_darkmode&sanitize=true" align=middle width=453.54615735pt height=22.831056599999986pt/>{c_i}<img src="/tex/9f578a1031e4db01a5bf8951d4ef0d50.svg?invert_in_darkmode&sanitize=true" align=middle width=100.8870192pt height=22.831056599999986pt/>{ g^{u_{i,j}} ) \mod p = h_{i,j} K_{i,j}^{c_i})  \mod p }<img src="/tex/afd56af11b8216cd43b3112aab819d87.svg?invert_in_darkmode&sanitize=true" align=middle width=414.1155546pt height=22.831056599999986pt/>{α}<img src="/tex/3df0ba55d27b35d7e025a2c7a517faa8.svg?invert_in_darkmode&sanitize=true" align=middle width=69.90698384999999pt height=22.831056599999986pt/>{ g^{P_i({\alpha})} \mod p }<img src="/tex/e3a45db2461eb22c66ddad1b522302c9.svg?invert_in_darkmode&sanitize=true" align=middle width=7642.6528183499995pt height=390.7326357pt/>{M}<img src="/tex/8f67d08d0230f637df10580c2389587f.svg?invert_in_darkmode&sanitize=true" align=middle width=312.48473355pt height=22.831056599999986pt/>{K}<img src="/tex/ff37ecfb4d867b440779901c0377c4c7.svg?invert_in_darkmode&sanitize=true" align=middle width=186.5714697pt height=22.831056599999986pt/>{R}<img src="/tex/2d6b4bef0bc89eb7b236d145f01e15ac.svg?invert_in_darkmode&sanitize=true" align=middle width=63.73313429999999pt height=22.831056599999986pt/>{0\leq R \leq q}$ and forming the pair (g^R  mod p,M⋅K^R  mod p).  An ElectionGuard ballot is comprised entirely of encryptions of one (indicating selection made) and zero (indicating selection not made).  To enable homomorphic addition (for tallying), these values are exponentiated during encryption.  Specifically, to encrypt a ballot entry, a random value R is selected such that 0≤R<q, and the following computation is performed.
