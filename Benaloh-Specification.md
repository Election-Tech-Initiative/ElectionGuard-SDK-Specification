...
When p is a prime for which, p-1=qr with q a prime that is not a divisor of integer r, then Z_p^r is an order q cyclic subgroup of <img src="/tex/6c5f692c5ffa62be214a66c14454c52b.svg?invert_in_darkmode&sanitize=true" align=middle width=19.132462799999992pt height=22.63846199999998pt/> and for each <img src="/tex/e8d2af97870ac5a121c9f5649cc620ee.svg?invert_in_darkmode&sanitize=true" align=middle width=27.78166874999999pt height=22.63846199999998pt/>, <img src="/tex/ddcb269909d2db499f38eb5809bf9316.svg?invert_in_darkmode&sanitize=true" align=middle width=27.503922599999992pt height=22.465723500000017pt/> if and only if <img src="/tex/aea5578797de49d2992d583feb309177.svg?invert_in_darkmode&sanitize=true" align=middle width=85.27345859999998pt height=22.831056599999986pt/>.
### Encryption
